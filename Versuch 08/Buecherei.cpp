...
int main()
{
    ...
    do  // Anzeige des Men�s
    {
        std::cout << std::endl
				  ...
				  << "(6): Alle ausgeliehnen Medien ausgeben" << std::endl
                  << "(7): Beenden" << std::endl;
...
void alleAusgeliehenenMedienAusgeben(std::vector<Medium*>& medien)
{
	std::cout << "Hier sind die von Ihnen ausgeliehenen Medien:" << std::endl << std::endl;
...
//		if(it->)
//		{
//					Warum geht das mit dem Iterator nicht?
//		}
//	}
	...
	{
		std::cout << "Sie haben kein Medium momentan ausgeliehen" << std::endl;
	}
